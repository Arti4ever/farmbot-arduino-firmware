...
int F13Handler::execute(Command *command)
{
  ...
  for (int stepNr = 0; stepNr < 7; stepNr++)
  {
    ...
    case 3: Movement::getInstance()->moveToCoords(xPos, yPos, moveAwayCoord, 0, 0, 0, false, false, false); break;
    case 4: Movement::getInstance()->moveToCoords(xPos, yPos, 0, 0, 0, 0, false, false, true); break;
    case 5: Movement::getInstance()->moveToCoords(xPos, yPos, moveAwayCoord, 0, 0, 0, false, false, false); break;
    case 6: Movement::getInstance()->moveToCoords(xPos, yPos, 0, 0, 0, 0, false, false, true); break;
    }
