...
int F12Handler::execute(Command *command)
{
  ...
  for (int stepNr = 0; stepNr < 7; stepNr++)
  {
    switch (stepNr)
    {
    case 0: Movement::getInstance()->moveToCoords(xPos, 0, zPos, 0, 0, 0, false, true, false); break;
    case 1: Movement::getInstance()->moveToCoords(xPos, moveAwayCoord, zPos, 0, 0, 0, false, false, false); break;
    case 2: Movement::getInstance()->moveToCoords(xPos, 0, zPos, 0, 0, 0, false, true, false); break;
    case 3: Movement::getInstance()->moveToCoords(xPos, moveAwayCoord, zPos, 0, 0, 0, false, false, false); break;
    case 4: Movement::getInstance()->moveToCoords(xPos, 0, zPos, 0, 0, 0, false, true, false); break;
    case 5: Movement::getInstance()->moveToCoords(xPos, moveAwayCoord, zPos, 0, 0, 0, false, false, false); break;
    case 6: Movement::getInstance()->moveToCoords(xPos, 0, zPos, 0, 0, 0, false, true, false); break;
    }
