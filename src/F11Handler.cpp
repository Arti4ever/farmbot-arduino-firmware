...
int F11Handler::execute(Command *command)
{
  ...
  for (int stepNr = 0; stepNr < 7; stepNr++)
  {
    switch (stepNr)
    {
      ...
      case 3: Movement::getInstance()->moveToCoords(moveAwayCoord, yPos, zPos, 0, 0, 0, false, false, false); break;
      case 4: Movement::getInstance()->moveToCoords(0, yPos, zPos, 0, 0, 0, true, false, false); break;
      case 5: Movement::getInstance()->moveToCoords(moveAwayCoord, yPos, zPos, 0, 0, 0, false, false, false); break;
      case 6: Movement::getInstance()->moveToCoords(0, yPos, zPos, 0, 0, 0, true, false, false); break;
    }
